...
import { PhilippinePeso, Check, Timer, WavesArrowDown } from "lucide-react";
...
export default function CoursesBox({
  ...
  return (
    <article className="border border-solid shadow-md rounded-2xl flex gap-4 flex-col lg:flex-col h-full">
      {/* <div className="w-full rounded-xl lg:rounded-bl-xl lg:rounded-tr-none lg:rounded-br-none">
        <video
      ...
      <aside className="flex-1 flex flex-col p-4 justify-between">
        <div className="flex flex-col justify-between w-full">
          <div>
            ...
            {description && (
              <p className="py-2 text-xs lg:text-base w-full min-w-0 whitespace-normal break-words [overflow-wrap:anywhere]">
                {description}
              </p>
            )}
          </div>
