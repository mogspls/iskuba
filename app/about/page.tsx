          ...
          <div className="max-w-screen-xl mx-auto w-full py-12 px-4">
            <div className="flex flex-col-reverse md:flex-row gap-12 items-center">
              ...
              <div className="flex-1">
                <img src="/images/about%20us.webp" alt="About Us" className="aspect-[4/3] object-center object-cover" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-screen-xl mx-auto w-full py-12 px-4">
            <div className="flex flex-col-reverse md:flex-row-reverse gap-12 items-center">
              <div className="py-4 [&>p]:py-2 md:[&>p]:text-xl">
                ...
                <h2 className="font-black text-2xl md:text-4xl">Meet Ivan, Our Course Director</h2>
                <div className="flex flex-col gap-4 py-4">
                  <p>As a PADI Course Director, Ivan has certified over 500 recreational divers and mentored many aspiring instructors. He has taught nationwide in the Philippines, dived across Asia, and even joined an underwater archaeological dig.</p>
                  <p>He has earned a reputation among his students for being a firm but fair instructor. His guiding principle is best captured in his own words: “I measure success by how far my students can go beyond me.”</p>
                  <p>If you’re ready to start your dive journey, or take the next step in it, you’ll find a home here.</p>
                  <p>Learn. Live. Teach with iSkuba.</p>
                </div>
              </div>
              <div className="flex">
                <img src="/images/meet-ivan.jpg" alt="Meet Ivan" className="aspect-square object-top object-center object-cover h-56 rounded-full md:h-full" />
              </div>
            </div>
          </div>
        </section>
        <section id="contact-us" className="bg-cover bg-center h-full" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('images/bg.jpg')" }}>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <a href="https://wa.me/639178214826" className="rounded-sm flex flex-col justify-center gap-4 bg-[#25d366] p-2 w-full">
                  <div className="flex gap-2 items-center">
                    ...
                    <h1 className="text-white font-bold text-xs sm:text-sm md:text-base">WhatsApp</h1>
                  </div>
                </a>
                <a href="sms:/639178214826" className="rounded-sm flex flex-col justify-center gap-4 bg-black p-2 w-full">
                  <div className="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="h-6 w-6 md:h-8 md:w-8">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    </svg>
                    <h1 className="text-white font-bold text-xs sm:text-sm md:text-base">SMS</h1>
                  </div>
                </a>
              </div>
            </div>
